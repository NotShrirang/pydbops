...
class Table(pydbops): 
    ...
    @overload
    def getFieldNames(self, returnType: str = "list") -> list: ...
    ...
    @overload
    def searchEntry(self, id: int = -1, keyword: str = "", returnType: str = "list", findAllOccurence: bool = False) -> list: ...

    @overload
    def searchEntry(self, id: int = -1, keyword: str = "", returnType: str = "list", findAllOccurence: bool = True) -> list: ...
    ...
    @overload
    def updateEntry(self, values: dict, field: str, whereFieldIs: int) -> bool: ...

    @overload
    def updateEntry(self, values: dict, field: str, whereFieldIs: str) -> bool: ...
    ...
    @overload
    def values(self, count: bool = False, list: bool = True) -> list: ...
