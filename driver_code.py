...
if __name__ == "__main__":
    ...
    t2.addEntry(values={"Name": "Shrirang", "Number" : 9404797231})

    # Adding entry in table with Database instance.
    d.addEntry(table="Table2", values={"Name": "Shrirang", "Number" : 9404797231})

    # Searching entry with keyword.
    d.searchEntry(table="Table2", keyword="Shrirang", returnType="ids", findAllOccurence=True)

    # Updating an entry.
    d.updateEntry(table="Table2", values={"Number" : 123}, whereField="Name", Is="Shrirang")
